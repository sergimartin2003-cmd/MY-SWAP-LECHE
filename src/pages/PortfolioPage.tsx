      ...
      <motion.div initial={{ opacity: 0, y: -15 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-sm rounded-xl px-4 py-2" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <button className="text-white/30 hover:text-white/70 transition-colors ml-1"><Copy size={13} /></button>
            <button className="text-white/30 hover:text-white/70 transition-colors"><ExternalLink size={13} /></button>
          </div>
        </div>
      </motion.div>
